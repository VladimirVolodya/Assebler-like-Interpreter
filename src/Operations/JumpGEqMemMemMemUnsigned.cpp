...
#include "Operations/JumpGEqMemMemMemUnsigned.h"

JumpGEqMemMemMemUnsigned::JumpGEqMemMemMemUnsigned(int32_t size, int32_t first_address, int32_t second_address,
...
void JumpGEqMemMemMemUnsigned::process(std::vector<int32_t> &registers, std::unordered_map<int32_t, int32_t> &memory,
                                        int32_t &ip) {
